...
Player.setRot(1,0,0, 0,1,0, 0,0,1);
Player.setPosRot(
...
ActorWatcher::doDrawRigidBodyAABB(0, 1); // main only
...
ActorWatcher::doTextWriterHavok(0, 1); // main only
ActorWatcher::doDrawHkBody(0, 1);
ActorWatcher::doDrawHkMotion(0, 1);
