...
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} ${CMAKE_C_FLAGS} -Wno-deprecated-declarations -Wno-format-zero-length -Wno-pointer-arith -Wno-invalid-offsetof -Wno-volatile -fno-exceptions -fno-rtti -fno-asynchronous-unwind-tables -fno-unwind-tables -fno-aggressive-loop-optimizations -fno-strict-aliasing" CACHE STRING "C++ flags")
