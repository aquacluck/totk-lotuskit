...
#define SEAD_ENUM(NAME, ...)                                                                       \
    ...
    public:                                                                                        \
        ...
        constexpr static int getLastIndex()                                                        \
        {                                                                                          \
            return size() - 1;                                                                     \
        }                                                                                          \
                                                                                                   \
...
#define SEAD_ENUM_EX(NAME, ...)                                                                    \
    ...
    public:                                                                                        \
        ...
        bool operator==(ValueType value) const                                                     \
        {                                                                                          \
            return mIdx == findRelativeIndex_(value);                                              \
        }                                                                                          \
        bool operator!=(ValueType value) const                                                     \
        {                                                                                          \
            return mIdx != findRelativeIndex_(value);                                              \
        ...
        int value() const                                                                          \
        {                                                                                          \
            return getArray_()[getRelativeIndex()];                                                \
        }                                                                                          \
        ...
        static int findRelativeIndex(ValueType value)                                              \
        {                                                                                          \
            return findRelativeIndex_(value);                                                      \
        }                                                                                          \
                                                                                                   \
        const char* getTypeText() const                                                            \
        {                                                                                          \
        ...
        static iterator end()                                                                      \
        {                                                                                          \
            return iterator(getArray_().size());                                                   \
        }                                                                                          \
                                                                                                   \
    private:                                                                                       \
        class ValueArray                                                                           \
        ...
        public:                                                                                    \
            ...
            {                                                                                      \
                return mSize;                                                                      \
                                                                                                   ...
                                                                                                   \
            int& operator[](s32 idx)                                                               \
            {                                                                                      \
                return *get(idx);                                                                  \
            }                                                                                      \
            const int& operator[](s32 idx) const                                                   \
            {                                                                                      \
                return *get(idx);                                                                  \
            }                                                                                      \
                                                                                                   \
