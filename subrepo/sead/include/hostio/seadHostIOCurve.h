...
public:
    ...
    // these are likely all non-matching now because this class completely changed so we'll ignore
    // them for now f32 interpolateToF32(f32 t) override; Vector2f interpolateToVec2f(f32 t)
    // override;
