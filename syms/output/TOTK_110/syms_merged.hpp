...
class HACK_cameraCalc {
    public:
    inline static constexpr ptrdiff_t offset = 0x00cdb894;
};
}
...
class applyLinearImpulse {
    public:
    inline static constexpr ptrdiff_t offset = 0x00ccc234;
};
}
...
class getBoundingBoxWorld {
    public:
    inline static constexpr ptrdiff_t offset = 0x00c2c050;
};
}
...
class getNextLinearVelocity {
    public:
    inline static constexpr ptrdiff_t offset = 0x011bb3b8;
};
}
...
class requestSetLinearVelocity {
    public:
    inline static constexpr ptrdiff_t offset = 0x007a4cfc;
};
}
...
class getName {
    public:
    inline static constexpr ptrdiff_t offset = 0x02a9750c;
};
}
...
class getActorLink {
    public:
    inline static constexpr ptrdiff_t offset = 0x006ee2f8;
};
}
...
class requestSetLinearVelocity {
    public:
    inline static constexpr ptrdiff_t offset = 0x00ee04dc;
};
}
...
class doUpdateMatrix {
    public:
    inline static constexpr ptrdiff_t offset = 0x00a8b40c;
};
}
