...
class HACK_cameraCalc {
    public:
    inline static constexpr ptrdiff_t offset = 0x00cb4474;
};
}
...
class visitRigidBodyEntities {
    public:
    inline static constexpr ptrdiff_t offset = 0x008aa374;
};
}
...
class applyLinearImpulse {
    public:
    inline static constexpr ptrdiff_t offset = 0x00cf600c;
};
}
...
class requestSetLinearVelocity {
    public:
    inline static constexpr ptrdiff_t offset = 0x00eb8640;
};
}
...
class doUpdateMatrix {
    public:
    inline static constexpr ptrdiff_t offset = 0x00a2e4b0;
};
}
